...
#define RMW_UXRCE_MAX_NODES 15
#define RMW_UXRCE_MAX_PUBLISHERS 15
#define RMW_UXRCE_MAX_SUBSCRIPTIONS 15
#define RMW_UXRCE_MAX_SERVICES 15
#define RMW_UXRCE_MAX_CLIENTS 15
