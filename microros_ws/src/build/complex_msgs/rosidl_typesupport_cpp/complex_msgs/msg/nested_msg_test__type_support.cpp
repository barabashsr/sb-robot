...
static const _NestedMsgTest_type_support_symbol_names_t _NestedMsgTest_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, complex_msgs, msg, NestedMsgTest)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, complex_msgs, msg, NestedMsgTest)),
  }
};
...
{
  return &::complex_msgs::msg::rosidl_typesupport_cpp::NestedMsgTest_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, complex_msgs, msg, NestedMsgTest)() {
  return get_message_type_support_handle<complex_msgs::msg::NestedMsgTest>();
}
