...
#include "rosidl_typesupport_microxrcedds_test_msg/msg/detail/regression10__rosidl_typesupport_fastrtps_c.h"
...
using _Regression10__ros_msg_type = rosidl_typesupport_microxrcedds_test_msg__msg__Regression10;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _Regression10__ros_msg_type * ros_message = static_cast<const _Regression10__ros_msg_type *>(untyped_ros_message);
  // Field name: a
  {
    cdr << ros_message->a;
  }
  ...
  // Field name: e
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, rosidl_typesupport_microxrcedds_test_msg, msg, Regression11
      )()->data);
    size_t size = 10;
    auto array_ptr = ros_message->e;
  ...
  void * untyped_ros_message)
{
  ...
  _Regression10__ros_msg_type * ros_message = static_cast<_Regression10__ros_msg_type *>(untyped_ros_message);
  // Field name: a
  {
    cdr >> ros_message->a;
  }
  ...
  size_t current_alignment)
{
  ...
  // field.name e
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_rosidl_typesupport_microxrcedds_test_msg__msg__Regression11(
  ...
  size_t current_alignment)
{
  ...
  // member: e
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_rosidl_typesupport_microxrcedds_test_msg__msg__Regression11(
...
static size_t _Regression10__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rosidl_typesupport_microxrcedds_test_msg__msg__Regression10(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rosidl_typesupport_microxrcedds_test_msg, msg, Regression10)() {
