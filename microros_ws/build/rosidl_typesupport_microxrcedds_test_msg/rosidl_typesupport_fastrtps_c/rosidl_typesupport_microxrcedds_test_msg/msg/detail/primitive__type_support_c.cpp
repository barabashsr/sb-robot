  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rosidl_typesupport_microxrcedds_test_msg__msg__Primitive;
    is_plain =
      (
      offsetof(DataType, nested_test) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _Primitive__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_rosidl_typesupport_microxrcedds_test_msg__msg__Primitive(
