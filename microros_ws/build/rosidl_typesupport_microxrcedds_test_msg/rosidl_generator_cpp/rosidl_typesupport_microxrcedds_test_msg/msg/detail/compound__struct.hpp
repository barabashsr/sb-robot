...
struct Compound_
{
  ...
  using _sequence_data_type =
    std::vector<rosidl_typesupport_microxrcedds_test_msg::msg::Primitive_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<rosidl_typesupport_microxrcedds_test_msg::msg::Primitive_<ContainerAllocator>>>;
  ...
  Type & set__sequence_data(
    const std::vector<rosidl_typesupport_microxrcedds_test_msg::msg::Primitive_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<rosidl_typesupport_microxrcedds_test_msg::msg::Primitive_<ContainerAllocator>>> & _arg)
  {
