...
void fetch_function__Sequence__sequence_string_test(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const std::string *>(
    get_const_function__Sequence__sequence_string_test(untyped_member, index));
  auto & value = *reinterpret_cast<std::string *>(untyped_value);
  value = item;
}

void assign_function__Sequence__sequence_string_test(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<std::string *>(
    get_function__Sequence__sequence_string_test(untyped_member, index));
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Sequence_message_member_array[1] = {
  {
    ...
    fetch_function__Sequence__sequence_string_test,  // fetch(index, &value) function pointer
    assign_function__Sequence__sequence_string_test,  // assign(index, value) function pointer
