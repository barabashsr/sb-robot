...
#include "rosidl_typesupport_microxrcedds_test_msg/msg/detail/sequence__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    cdr << ros_message.sequence_string_test;
  }
  return true;
}
  ...
  size_t current_alignment)
{
  ...
  // Member: sequence_string_test
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += padding +
        eprosima::fastcdr::Cdr::alignment(current_alignment, padding) +
        (ros_message.sequence_string_test[index].size() + 1);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rosidl_typesupport_microxrcedds_test_msg::msg::Sequence;
    is_plain =
      (
      offsetof(DataType, sequence_string_test) +
      last_member_size
      ) == ret_val;
  }
...
{
  return &rosidl_typesupport_microxrcedds_test_msg::msg::typesupport_fastrtps_cpp::_Sequence__handle;
}
