  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rosidl_typesupport_microxrcedds_test_msg::msg::NotEnoughtMemoryTest;
    is_plain =
      (
...
static size_t _NotEnoughtMemoryTest__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_NotEnoughtMemoryTest(full_bounded, is_plain, 0);
