    ...
    def float32_array_test(self, value):
        ...
        if __debug__:
            ...
            assert \
                ...
                "The 'float32_array_test' field must be a set or sequence with length 11 and each value of type 'float' and each float in [-340282346600000016151267322115014000640.000000, 340282346600000016151267322115014000640.000000]"
    ...
    def float64_array_test(self, value):
        ...
        if __debug__:
            ...
            assert \
                ...
                "The 'float64_array_test' field must be a set or sequence with length 11 and each value of type 'float' and each double in [-.000000, .000000]"
