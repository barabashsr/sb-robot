...
void fetch_function__NotEnoughtMemoryTest__int64_sequence(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const int64_t *>(
    get_const_function__NotEnoughtMemoryTest__int64_sequence(untyped_member, index));
  auto & value = *reinterpret_cast<int64_t *>(untyped_value);
  value = item;
}

void assign_function__NotEnoughtMemoryTest__int64_sequence(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<int64_t *>(
    get_function__NotEnoughtMemoryTest__int64_sequence(untyped_member, index));
...
void fetch_function__NotEnoughtMemoryTest__int16_array(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const int16_t *>(
    get_const_function__NotEnoughtMemoryTest__int16_array(untyped_member, index));
  auto & value = *reinterpret_cast<int16_t *>(untyped_value);
  value = item;
}

void assign_function__NotEnoughtMemoryTest__int16_array(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<int16_t *>(
    get_function__NotEnoughtMemoryTest__int16_array(untyped_member, index));
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember NotEnoughtMemoryTest_message_member_array[5] = {
  ...
  },
  {
    ...
    fetch_function__NotEnoughtMemoryTest__int64_sequence,  // fetch(index, &value) function pointer
    assign_function__NotEnoughtMemoryTest__int64_sequence,  // assign(index, value) function pointer
  ...
  },
  {
    ...
    fetch_function__NotEnoughtMemoryTest__int16_array,  // fetch(index, &value) function pointer
    assign_function__NotEnoughtMemoryTest__int16_array,  // assign(index, value) function pointer
    nullptr  // resize(index) function pointer
  },
  {
    "end_byte",  // name
