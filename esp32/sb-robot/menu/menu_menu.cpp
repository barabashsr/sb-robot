...
// Generated for Arduino ESP32 by TcMenu 4.4.0 on 2025-02-15T06:18:25.210463Z.
...
U8G2_SH1106_128X64_NONAME_F_HW_I2C gfx(U8G2_R2, U8X8_PIN_NONE, 22, 21);
U8g2Drawable gfxDrawable(&gfx);
GraphicsDeviceRenderer renderer(30, applicationInfo.name, &gfxDrawable);

// Global Menu Item declarations
const PROGMEM AnalogMenuInfo minfoPIDInterval = { "PID interval", 8, 0xffff, 255, SetPIDHz, 0, 1, "ms" };
AnalogMenuItem menuPIDInterval(&minfoPIDInterval, 10, nullptr, INFO_LOCATION_PGM);
const PROGMEM AnalogMenuInfo minfoKo = { "Ko", 7, 0xffff, 500, SetKo, 0, 10, "" };
AnalogMenuItem menuKo(&minfoKo, 15, &menuPIDInterval, INFO_LOCATION_PGM);
const PROGMEM AnalogMenuInfo minfoKd = { "Kd", 6, 0xffff, 500, SetKd, 0, 10, "" };
AnalogMenuItem menuKd(&minfoKd, 20, &menuKo, INFO_LOCATION_PGM);
const PROGMEM AnalogMenuInfo minfoKi = { "Ki", 5, 0xffff, 500, SetKi, 0, 10, "" };
AnalogMenuItem menuKi(&minfoKi, 5, &menuKd, INFO_LOCATION_PGM);
const PROGMEM AnalogMenuInfo minfoKp = { "Kp", 4, 0xffff, 500, SetKp, 0, 10, "" };
...
FloatMenuItem menuTicksB(&minfoTicksB, 0.0, &menuPIDParams, INFO_LOCATION_PGM);
...
const PROGMEM AnalogMenuInfo minfoSetB = { "SetB", 12, 0xffff, 500, SetSpeedA, -250, 10, "rps" };
AnalogMenuItem menuSetB(&minfoSetB, 0, &menuSpeedB, INFO_LOCATION_PGM);
...
AnalogMenuItem menuSetA(&minfoSetA, 0, &menuSpeedA, INFO_LOCATION_PGM);
