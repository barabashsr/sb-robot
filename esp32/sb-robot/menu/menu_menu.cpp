...
<<<<<<< .merge_file_HeYhRA
// Generated for Arduino ESP32 by TcMenu 4.4.0 on 2025-03-07T11:14:45.829739894Z.
=======
...
SubMenuItem menuYawPID(&minfoYawPID, &menuBackYawPID, &menuVel, INFO_LOCATION_PGM);
...
const PROGMEM AnalogMenuInfo minfoKoVel = { "Ko vel", 47, 52, 700, SetKoVel, 0, 10, "" };
AnalogMenuItem menuKoVel(&minfoKoVel, 200, &menuPeriodV, INFO_LOCATION_PGM);
const PROGMEM AnalogMenuInfo minfoKdVel = { "Kd vel", 18, 24, 7000, SetKdVel, 0, 100, "" };
AnalogMenuItem menuKdVel(&minfoKdVel, 200, &menuKoVel, INFO_LOCATION_PGM);
const PROGMEM AnalogMenuInfo minfoKiVel = { "Ki vel", 17, 22, 7000, SetKiVel, 0, 100, "" };
AnalogMenuItem menuKiVel(&minfoKiVel, 5, &menuKdVel, INFO_LOCATION_PGM);
const PROGMEM AnalogMenuInfo minfoKpVel = { "Kp vel", 16, 20, 7000, SetKpVel, 0, 100, "" };
...
AnalogMenuItem menuSetYaw(&minfoSetYaw, 50, &menuPitch, INFO_LOCATION_PGM);
...
FloatMenuItem menuPalstance(&minfoPalstance, 0.0, &menuSetVel, INFO_LOCATION_PGM);
=======
...
<<<<<<< .merge_file_HeYhRA
    ...
    menuPalstance.setVisible(false);
    menuPalstPID.setVisible(false);
    menuKoVel.setVisible(false);
    menuMotorConfig.setVisible(false);
